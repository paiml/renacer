...
- [Basic Tracing](./getting-started/basic-tracing.md)
- [Understanding Output](./getting-started/understanding-output.md)

# Core Concepts

- [System Call Tracing](./core-concepts/syscall-tracing.md)
- [DWARF Source Correlation](./core-concepts/dwarf-correlation.md)
- [Filtering Syscalls](./core-concepts/filtering.md)
  - [Syscall Classes](./core-concepts/filtering-classes.md)
  - [Negation Operator](./core-concepts/filtering-negation.md)
  - [Regex Patterns](./core-concepts/filtering-regex.md)
- [Statistics Mode](./core-concepts/statistics.md)
- [Output Formats](./core-concepts/output-formats.md)
...
- [Export to JSON/CSV](./examples/export-data.md)
- [Generate HTML Reports](./examples/html-reports.md)

# Advanced Topics

- [Function Profiling](./advanced/function-profiling.md)
  - [I/O Bottleneck Detection](./advanced/io-bottlenecks.md)
  - [Call Graph Analysis](./advanced/call-graphs.md)
  - [Flamegraph Export](./advanced/flamegraphs.md)
- [Statistical Analysis](./advanced/statistical-analysis.md)
  - [Percentile Analysis](./advanced/percentiles.md)
  - [SIMD Acceleration](./advanced/simd-acceleration.md)
- [Anomaly Detection](./advanced/anomaly-detection.md)
  - [Post-Hoc Analysis](./advanced/post-hoc-anomaly.md)
  - [Real-Time Monitoring](./advanced/realtime-anomaly.md)
- [HPU Acceleration](./advanced/hpu-acceleration.md)
...
- [Single-Shot Compile Tooling](./advanced/single-shot-compile.md)
  ...
  - [Golden Trace Validation](./advanced/golden-trace-validation.md)
  - [Anti-Pattern Detection](./advanced/anti-pattern-detection.md)

# Reference

- [CLI Reference](./reference/cli.md)
  - [Tracing Options](./reference/tracing-options.md)
  - [Filter Syntax](./reference/filter-syntax.md)
  - [Output Options](./reference/output-options.md)
  - [Analysis Flags](./reference/analysis-flags.md)
- [Output Formats](./reference/output-formats.md)
  - [Text Format](./reference/format-text.md)
  - [JSON Format](./reference/format-json.md)
  - [CSV Format](./reference/format-csv.md)
  - [HTML Format](./reference/format-html.md)
...
- [EXTREME TDD](./contributing/extreme-tdd.md)
  - [RED-GREEN-REFACTOR](./contributing/red-green-refactor.md)
  - [Property-Based Testing](./contributing/property-testing.md)
  - [Mutation Testing](./contributing/mutation-testing.md)
  - [Fuzz Testing](./contributing/fuzz-testing.md)
  - [Tiered TDD Workflow](./contributing/tiered-tdd.md)
- [Chaos Engineering](./contributing/chaos-engineering.md)
